...
RAILWAY_STATIONS = {
    ...
    "総武線": ["東京", "新日本橋", "馬喰町", "錦糸町", "亀戸", "新小岩", "市川", "船橋", "津田沼", "千葉"],
    "総武快速線": ["東京", "新日本橋", "馬喰町", "錦糸町", "亀戸", "新小岩", "市川", "船橋", "津田沼", "千葉"],
    "丸ノ内線": ["荻窪", "南阿佐ヶ谷", "新高円寺", "東高円寺", "新中野", "中野坂上", "西新宿", "新宿", "新宿三丁目",
                "新宿御苑前", "四谷三丁目", "四ツ谷", "赤坂見附", "国会議事堂前", "霞ケ関", "銀座", "東京", "大手町",
...
def main():
    ...
    # 读取7分以上且没有広告数的物件
    with open('data/high_view_props.json', 'r', encoding='utf-8') as f:
        properties = json.load(f)

    # 只处理7分以上的物件
    properties = [p for p in properties if p.get('score', 0) >= 7]
